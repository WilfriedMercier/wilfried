...
#define folder_height 24
static unsigned char folder_bits[] = {
   0xff, 0x03, 0x00, 0xff, 0x03, 0x00, 0x03, 0xfe, 0xff, 0x03, 0xfc, 0xff,
   0xff, 0x0f, 0xc0, 0xff, 0x0f, 0xc0, 0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0,
   0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0,
   0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0,
   0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0,
   0x03, 0x00, 0xc0, 0x03, 0x00, 0xc0, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};""",
                 'mask':"""
#define folder_mask_width 24
#define folder_mask_height 24
static unsigned char folder_mask_bits[] = {
   0xff, 0x03, 0x00, 0xff, 0x03, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static unsigned char file_bits[] = {
   0xff, 0x1f, 0x00, 0x01, 0x30, 0x00, 0x01, 0x50, 0x00, 0x01, 0x90, 0x00,
   0x01, 0x10, 0x01, 0x01, 0xf0, 0x03, 0x01, 0x00, 0x02, 0x01, 0x00, 0x02,
   0x01, 0x03, 0x02, 0x01, 0x03, 0x02, 0x01, 0x03, 0x02, 0xe1, 0x1f, 0x02,
   0xe1, 0x1f, 0x02, 0x01, 0x03, 0x02, 0x01, 0x03, 0x02, 0x01, 0x03, 0x02,
   0x01, 0x00, 0x02, 0x01, 0x00, 0x02, 0x01, 0x00, 0x02, 0x01, 0x00, 0x02,
   0x01, 0x00, 0x02, 0x01, 0x00, 0x02, 0x01, 0x00, 0x02, 0xff, 0xff, 0x03};"""    ,
                 'mask':"""
#define file_mask_width 18
#define file_mask_height 24
static unsigned char file_mask_bits[] = {
   0xff, 0x1f, 0x00, 0xff, 0x3f, 0x00, 0xff, 0x7f, 0x00, 0xff, 0xff, 0x00,
...
DELETEICON     = {'data':"""
#define delete_width 19
#define delete_height 22
static unsigned char delete_bits[] = {
   0xe0, 0x3f, 0x00, 0x20, 0x20, 0x00, 0xf8, 0xff, 0x00, 0xfe, 0xff, 0x03,
   0xff, 0xff, 0x07, 0x1f, 0xc0, 0x07, 0x58, 0xd2, 0x00, 0x58, 0xd2, 0x00,
   0x58, 0xd2, 0x00, 0x58, 0xd2, 0x00, 0x58, 0xd2, 0x00, 0x58, 0x02, 0x00,
   0x58, 0xfa, 0x03, 0x58, 0xea, 0x02, 0x58, 0x5a, 0x03, 0x58, 0xba, 0x03,
   0x58, 0x5a, 0x03, 0x58, 0xea, 0x02, 0x58, 0xfa, 0x03, 0x18, 0x00, 0x00,
   0xf8, 0xff, 0x00, 0xf8, 0xff, 0x00};""",
                 'mask':"""
#define delete_mask_width 19
#define delete_mask_height 22
static unsigned char delete_mask_bits[] = {
   0xe0, 0x3f, 0x00, 0xe0, 0x3f, 0x00, 0xf8, 0xff, 0x00, 0xfe, 0xff, 0x03,
   0xff, 0xff, 0x07, 0xff, 0xff, 0x07, 0xf8, 0xff, 0x00, 0xf8, 0xff, 0x00,
   0xf8, 0xff, 0x00, 0xf8, 0xff, 0x00, 0xf8, 0xff, 0x00, 0xf8, 0xff, 0x00,
   0xf8, 0xff, 0x03, 0xf8, 0xff, 0x03, 0xf8, 0xff, 0x03, 0xf8, 0xff, 0x03,
   0xf8, 0xff, 0x03, 0xf8, 0xff, 0x03, 0xf8, 0xff, 0x03, 0xf8, 0xff, 0x00,
   0xf8, 0xff, 0x00, 0xf8, 0xff, 0x00};"""}
...
static unsigned char save_bits[] = {
   0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
   0xff, 0xff, 0xff, 0xff, 0x7f, 0xfc, 0xff, 0x7f, 0xfc, 0xff, 0x7f, 0xfc,
   0xff, 0x7f, 0xfc, 0xff, 0x7f, 0xfc, 0xff, 0x7f, 0xfc, 0xff, 0x7f, 0xfc,
   0xff, 0x07, 0xc0, 0xff, 0x0f, 0xe0, 0xff, 0x1f, 0xf0, 0xff, 0x3f, 0xf8,
   0xff, 0x7f, 0xfc, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
   0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};""",
                  'mask':"""
#define save_mask_width 24
#define save_mask_height 24
static unsigned char save_mask_bits[] = {
   0x0f, 0x00, 0x06, 0xcf, 0x03, 0x0e, 0x4f, 0x02, 0x1e, 0x4f, 0x02, 0x3e,
   0x4f, 0x02, 0x7e, 0xcf, 0x83, 0xff, 0x0f, 0x80, 0xff, 0xff, 0xff, 0xff,
   0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
   0xff, 0xff, 0xff, 0x0f, 0xf0, 0xff, 0x0f, 0xe0, 0xff, 0xef, 0xcf, 0xf7,
   0x0f, 0x80, 0xf3, 0x0f, 0x00, 0xf1, 0xef, 0x7f, 0xf4, 0x0f, 0x00, 0xf0,
...
class topFrame(tk.Frame):
    ...
    def __init__(self, parent, root, bgColor='grey'):
        ...
        self.dlt.button  = tk.Button(self.buttonFrame, image=self.dlt.icon, bd=0,
                                     bg=self.bgColor, highlightbackground=self.bgColor, relief=tk.FLAT)
        self.dlt.button.bind('<Enter>', lambda event: self.dlt.icon.configure(foreground='red3'))
        self.dlt.button.bind('<Leave>', lambda event: self.dlt.icon.configure(foreground='black'))
        
        self.save        = container()
        self.save.icon   = tk.BitmapImage(data=SAVEICON['data'], maskdata=SAVEICON['mask'], background='black', foreground='dark slate gray')
        self.save.button = tk.Button(self.buttonFrame, image=self.save.icon, bd=0,
                                     bg=self.bgColor, highlightbackground=self.bgColor, highlightthickness=0, relief=tk.FLAT)
        self.save.button.bind('<Enter>', lambda event: self.save.icon.configure(background='green4'))
        self.save.button.bind('<Leave>', lambda event: self.save.icon.configure(background='black'))
        ...
        self.dlt.button.grid( row=1, column=1, sticky=tk.E)
        self.save.button.grid(row=1, column=0, sticky=tk.W)
